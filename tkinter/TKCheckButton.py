...
class AutomagicaTk(tk.Tk):
    ...
    def createTkCheckButton(self):
        ...
        tk.Checkbutton(self.tkFrame, text="单选框", cursor="hand2", variable=self.is_checked,
                       command=self.get_checkbutton_value, onvalue='yes', offvalue='no').pack(side=tk.LEFT)
